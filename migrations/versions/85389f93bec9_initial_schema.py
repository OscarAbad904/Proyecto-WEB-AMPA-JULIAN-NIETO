...
class EncryptedType(TypeDecorator):
    """Tipo compatible con la migración original.

    En la migración solo importa el tipo SQL subyacente; la lógica real de
    encriptado/descifrado vive en el modelo.
    """
...
def upgrade():
    ...
    sa.Column('name', EncryptedType(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('username', EncryptedType(), nullable=False),
    ...
    sa.Column('first_name', EncryptedType(), nullable=True),
    sa.Column('last_name', EncryptedType(), nullable=True),
    sa.Column('phone_number', EncryptedType(), nullable=True),
    sa.Column('address', EncryptedType(), nullable=True),
    sa.Column('city', EncryptedType(), nullable=True),
    sa.Column('postal_code', EncryptedType(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', EncryptedType(), nullable=False),
    sa.Column('file_path', EncryptedType(), nullable=False),
    ...
    sa.Column('description_html', EncryptedType(), nullable=False),
    ...
    sa.Column('title', EncryptedType(), nullable=False),
    sa.Column('slug', sa.String(length=255), nullable=False),
    sa.Column('body_html', EncryptedType(), nullable=False),
    sa.Column('excerpt', EncryptedType(), nullable=True),
    sa.Column('status', sa.Enum('draft', 'published', 'scheduled', name='post_status'), nullable=False),
    sa.Column('category', sa.String(length=64), nullable=False),
    sa.Column('tags', EncryptedType(), nullable=True),
    sa.Column('cover_image', EncryptedType(), nullable=True),

...
class BaseConfig:
    ...
    GOOGLE_DRIVE_COMMISSIONS_FOLDER_ID = os.getenv("GOOGLE_DRIVE_COMMISSIONS_FOLDER_ID", "")
    GOOGLE_DRIVE_COMMISSIONS_FOLDER_NAME = os.getenv("GOOGLE_DRIVE_COMMISSIONS_FOLDER_NAME", "Comisiones")
